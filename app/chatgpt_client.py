...
class ChatGPTClient:
    ...
    def determine_actions(self, thread_formatted: str) -> list[dict]:
        """
        Analyze a thread and return relevant Shopify actions with their parameters.
    ...
    def summarize_thread(self, thread_formatted: str) -> str:
        """
        Generate a concise plain-text summary of a thread.
        """
        prompt = SUMMARIZE_THREAD_PROMPT.format(email_thread=thread_formatted)
